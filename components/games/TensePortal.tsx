        ...
        <motion.div className="glass-strong rounded-2xl p-8 max-w-md w-full text-center">
          ...
          <div className="grid grid-cols-3 gap-3 mb-6">
            <div className="glass rounded-xl p-3">
              ...
              <div className="text-xs text-gray-400 dark:text-white/50">Верно</div>
            </div>
            <div className="glass rounded-xl p-3">
              <div className="text-xl font-bold font-mono text-red-400">{wrong}</div>
              <div className="text-xs text-gray-400 dark:text-white/50">Ошибки</div>
            </div>
            <div className="glass rounded-xl p-3">
              <div className="text-xl font-bold font-mono text-orange-400">{bestStreak}</div>
              <div className="text-xs text-gray-400 dark:text-white/50">Серия</div>
            </div>
          </div>
          ...
          >
            ...
            <div className="glass-card rounded-2xl p-6">
              <div className="relative h-10 mb-3">
                ...
                <motion.div
                  className="absolute top-1/2 w-5 h-5 -translate-y-1/2 -translate-x-1/2 rounded-full bg-white dark:bg-gray-200 border-2 border-primary shadow-lg shadow-primary/30"
                  initial={{ left: "0%" }}
